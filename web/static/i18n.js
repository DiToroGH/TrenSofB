...
(function () {
  ...
  const STRINGS = {
    es: {
      ...
      dlgRegistroHint:
        "Corregí conductor y VIP confirmados para fechas anteriores a hoy. El VIP es opcional.",
      registroLabelFecha: "Fecha",
      registroLabelConductor: "Conductor",
    ...
    en: {
      ...
      dlgRegistroHint:
        "Fix confirmed driver and VIP for dates before today. VIP is optional.",
      registroLabelFecha: "Date",
      registroLabelConductor: "Driver",
    ...
    pt: {
      ...
      dlgRegistroHint:
        "Corrija condutor e VIP confirmados para datas anteriores a hoje. O VIP é opcional.",
      registroLabelFecha: "Data",
      registroLabelConductor: "Condutor",
